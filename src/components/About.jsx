...
function About() {
  return (
    <div id="about" className="w-full md:h-screen p-2 flex flex-col justify-center items-center pt-20">
      <p className="uppercase text-xl md:text-2xl tracking-widest text-[#5250a4] pb-8">
        About
      </p>
      <div>
        <div className="max-w-[1240px] m-auto md:grid grid-cols-3 gap-8 text-left">
          <div className="col-span-2">
            ...
            <p className="py-2 text-md md:text-xl text-[#ecf0f3]">
